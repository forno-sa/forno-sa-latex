...
\begin{figure}[H]
	...
	\includegraphics[keepaspectratio=true,scale=0.8]{figuras/tab_constantes.JPG}
...
\begin{figure}[H]
	\centering
	\label{resfriamento1}
	\includegraphics[keepaspectratio=true,scale=0.7]{figuras/resfriamento1.JPG}
...
\begin{figure}[H]
	\centering
	\label{diagramattt}
	\includegraphics[keepaspectratio=true,scale=0.9]{figuras/diagramattt.JPG}
...
\begin{figure}[H]
	...
	\includegraphics[keepaspectratio=true,scale=0.9]{figuras/diagramacircuito.JPG}
...
\begin{figure}[H]
	...
	\includegraphics[keepaspectratio=true,scale=0.9]{figuras/circuitocontrole.JPG}
