...
\begin{figure}[ht]
	\centering
	\label{ansys1}
	\includegraphics[keepaspectratio=true,scale=0.8]{%TODO}
...
em W/m³, e foi calculado dividindo se a potência das resistências consideradas (embaixo e encima
...
maior range de temperatura alcance os 1200 o C. Nas espiras também foi adicionado a emissividade
